...
RSpec.describe IsoDoc::Ogc do
           ...
           <div class="TOC">
              ...
              <p class="MsoToc1">
                 ...
                 <span class="MsoHyperlink">
                    <span lang="EN-GB" style="mso-no-proof:yes" xml:lang="EN-GB">
                       <a href="#_Toc">
                          1<span class="fmt-autonum-delim">.</span> Clause 4
              ...
              <p class="MsoToc2">
                 <span class="MsoHyperlink">
                    <span lang="EN-GB" style="mso-no-proof:yes" xml:lang="EN-GB">
                       <a href="#_Toc">
                          1.1<span class="fmt-autonum-delim">.</span> Introduction to this
                          <span lang="EN-GB" class="MsoTocTextSpan" xml:lang="EN-GB">
                             <span style="mso-tab-count:1 dotted">. </span>
                          </span>
                          <span lang="EN-GB" class="MsoTocTextSpan" xml:lang="EN-GB">
              ...
              <p class="MsoToc2">
                 <span class="MsoHyperlink">
                    <span lang="EN-GB" style="mso-no-proof:yes" xml:lang="EN-GB">
                       <a href="#_Toc">
                          1.2<span class="fmt-autonum-delim">.</span> Clause 4.2
                          <span lang="EN-GB" class="MsoTocTextSpan" xml:lang="EN-GB">
                             <span style="mso-tab-count:1 dotted">. </span>
                          </span>
                          <span lang="EN-GB" class="MsoTocTextSpan" xml:lang="EN-GB">
  ...
  it "processes boilerplate" do
    ...
    word = Nokogiri::HTML(File.read("test.doc"))
    word = word.at("//div[@class = 'boilerplate-copyright']")
    expect(word.to_xhtml)
      .to be_html4_equivalent_to output
    output = <<~OUTPUT
      <div class='boilerplate-license'>
          <div><p class="TitlePageSubhead">License Agreement</p>
          <p class="license">C</p></div></div>
    OUTPUT
    word = Nokogiri::HTML(File.read("test.doc"))
    word = word.at("//div[@class = 'boilerplate-license']")
    expect(word.to_xhtml)
      .to be_html4_equivalent_to output
  end
