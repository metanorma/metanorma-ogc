...
RSpec.describe IsoDoc::Ogc do
  ...
  it "processes simple terms & definitions" do
    ...
    html = <<~OUTPUT
      <div id="H">
         <h1 id="_"><a class="anchor" href="#H"></a><a class="header" href="#H">1<span class="fmt-autonum-delim">.</span>  Terms, Definitions, Symbols and Abbreviated Terms</a></h1>
         <div id="J">
           <h2 class="TermNum" style="text-align:left;" id="_"><a class="anchor" href="#J"></a><a class="header" href="#J">1.1<span class="fmt-autonum-delim">.</span> <b><dfn>Term2</dfn></b></a></h2>
         </div>
    ...
    doc = <<~OUTPUT
      <body>
          <div class="WordSection3">
             <div>
                <a name="H" id="H"></a>
                <h1>1<span class="fmt-autonum-delim">.</span><span style="mso-tab-count:1">  </span>Terms, Definitions, Symbols and Abbreviated Terms</h1>
                <p class="TermNum" style="text-align:left;"><a name="J" id="J"></a>1.1<span class="fmt-autonum-delim">.</span> <b>Term2</b></p>
                <p class="AltTerms" style="text-align:left;">
                   Term2A#{' '}
                   <span class="AdmittedLabel">ALTERNATIVE</span>
                </p>
    ...
    xml = xml.at("//div[@id = 'H']")
    expect(strip_guid(xml.to_xhtml)).to be_html5_equivalent_to html
  ...
  it "processes section names" do
      ...
      <bibdata>
        ...
        #{METANORMA_EXTENSION}
          ...
          <preface>
             ...
             <clause type="submitters" obligation="informative" id="3" displayorder="7">
             ...
             <clause type="contributors" obligation="informative" id="3a" displayorder="8">
          ...
          <sections>
             ...
             <clause id="H" obligation="normative" displayorder="14">
                <title id="_">Terms, definitions, symbols and abbreviated terms</title>
                <fmt-title depth="1" id="_">
                   <span class="fmt-caption-label">
             ...
             <definitions id="L" displayorder="15">
                <title id="_">Definitions</title>
                <fmt-title depth="1" id="_">
                   <span class="fmt-caption-label">
             ...
             <clause id="M" inline-header="false" obligation="normative" displayorder="16">
    ...
    presxml1 = <<~OUTPUT
         ...
         <annex id="PP" obligation="normative" autonum="B" displayorder="18">
         ...
         <annex id="QQ" obligation="normative" autonum="C" displayorder="19">
            <title id="_">Glossary</title>
            <fmt-title id="_">
               <strong>
                  <span class="fmt-caption-label">
    ...
    output = <<~"OUTPUT"
      ...
      <br/>
             <div id="1">
                <h1 class="AbstractTitle">I<span class="fmt-autonum-delim">.</span>  Abstract</h1>
                <p>XYZ</p>
             </div>
             <br/>
             <div class="Section3" id="DD0">
                <h1 class="IntroTitle">II<span class="fmt-autonum-delim">.</span>  Executive Summary</h1>
                <p id="EE0">Text</p>
             </div>
             <div class="Section3" id="_">
                <h1 class="IntroTitle">III<span class="fmt-autonum-delim">.</span>  Keywords</h1>
                <p>The following are keywords to be used by search engines and document catalogues.</p>
                <p>A, B</p>
             </div>
             <br/>
             <div id="2">
                <h1 class="ForewordTitle">IV<span class="fmt-autonum-delim">.</span>  Preface</h1>
                <p id="A">This is a preamble</p>
             </div>
             <div class="Section3" id="DD1">
                <h1 class="IntroTitle">V<span class="fmt-autonum-delim">.</span>  Security</h1>
                <p id="EE1">Text</p>
             </div>
             <div class="Section3" id="3">
                <h1 class="IntroTitle">VI<span class="fmt-autonum-delim">.</span>  Submitters</h1>
                <p>ABC</p>
             </div>
             <div class="Section3" id="3a">
                <h1 class="IntroTitle">VII<span class="fmt-autonum-delim">.</span>  Contributors</h1>
                <p>ABC</p>
             </div>
             <div class="Section3" id="5">
                <h1 class="IntroTitle">VIII<span class="fmt-autonum-delim">.</span>  Dedication</h1>
                <div id="6">
                   <h2>VIII.A<span class="fmt-autonum-delim">.</span>  Note to readers</h2>
                </div>
             </div>
             <div class="Section3" id="4">
                <h1 class="IntroTitle">IX<span class="fmt-autonum-delim">.</span>  Acknowlegements</h1>
                <p>ABC</p>
             </div>
             <div id="D">
             ...
             <div id="D1">
                <h1>2<span class="fmt-autonum-delim">.</span>  Conformance</h1>
                <p id="E1">Text</p>
             </div>
             <div>
                <h1>3<span class="fmt-autonum-delim">.</span>  Normative References</h1>
             </div>
             <div id="H">
                <h1>4<span class="fmt-autonum-delim">.</span>  Terms, definitions, symbols and abbreviated terms</h1>
                <div id="I">
                   <h2>4.1<span class="fmt-autonum-delim">.</span>  Normal Terms</h2>
                   <p class="TermNum" id="J">4.1.1<span class="fmt-autonum-delim">.</span></p>
                ...
                <div id="K">
                   <h2>4.2<span class="fmt-autonum-delim">.</span>  Definitions</h2>
                   <div class="figdl">
                      <dl>
                         <dt>
                            <p>Symbol</p>
             ...
             <div id="L" class="Symbols">
                <h1>5<span class="fmt-autonum-delim">.</span>  Definitions</h1>
                <div class="figdl">
                   <dl>
                      <dt>
                         <p>Symbol</p>
             ...
             <div id="M">
                <h1>6<span class="fmt-autonum-delim">.</span>  Clause 4</h1>
                <div id="N">
                   <h2>6.1<span class="fmt-autonum-delim">.</span>  Introduction</h2>
                </div>
                <div id="O">
                   <h2>6.2<span class="fmt-autonum-delim">.</span>  Clause 4.2</h2>
                </div>
             </div>
             <br/>
    OUTPUT
    ...
    output1 = <<~OUTPUT
            ...
            <div id="PP" class="Section3">
               ...
               <div id="PP1">
                  <p class="TermNum" id="term-glossary">B.1<span class="fmt-autonum-delim">.</span></p>
            ...
            <div id="QQ" class="Section3">
               ...
               <div id="QQ1">
                  <h2>C.1<span class="fmt-autonum-delim">.</span>  Term Collection</h2>
                  <p class="TermNum" id="term-term-1">C.1.1<span class="fmt-autonum-delim">.</span></p>
                  <p class="Terms" style="text-align:left;"><b><dfn>Term</dfn></b></p>
               </div>
               <div id="QQ2">
                  <h2>C.2<span class="fmt-autonum-delim">.</span>  Term Collection 2</h2>
                  <p class="TermNum" id="term-term-2">C.2.1<span class="fmt-autonum-delim">.</span></p>
                  <p class="Terms" style="text-align:left;"><b><dfn>Term</dfn></b></p>
               </div>
            </div>
            <br/>
    ...
    xml.at("//xmlns:localized-strings").remove
    expect(strip_guid(xml.to_xml))
      .to be_xml_equivalent_to presxml + presxml1
    expect(strip_guid(
      ...
      .to be_html5_equivalent_to output + output1
    ...
    presxml2 = <<~OUTPUT
         ...
         <bibliography>
            <clause id="S" obligation="informative" unnumbered="true" displayorder="17">
               <title id="_">Bibliography</title>
               <fmt-title depth="1" id="_">
                  <semx element="title" source="_">Bibliography</semx>
               </fmt-title>
    ...
    expect(strip_guid(xml.to_xml))
      .to be_equivalent_to presxml
        .sub("technical-paper", "engineering-report") + presxml2
    expect(strip_guid(IsoDoc::Ogc::HtmlConvert.new({})
      .convert("test", pres_output, true)
      .gsub(%r{^.*<body}m, "<body")
      .gsub(%r{</body>.*}m, "</body>"))).to be_xml_equivalent_to (output + output2)
  end
end
